...
PE_PAT = r"(Parameter\(s\)\s:)|(Initial Condition(s):) (([A-Za-z0-9\_]+)[ ]*=[ ]*([0-9.e+-]+[ a-zA-Z0-9]*))"
#AMIGO2_PAT = r"([A-Za-z0-9\_]+)\s+:\s+([0-9.e+-]+)"
#IQM_PAT = r"([A-Za-z0-9\_]+)[ ]*=[ ]*([0-9.e+-]+[ a-zA-Z0-9]*)"
...
def parse_output(output):
    ...
    if total_res > 2: print("GO OVER THESE RESULTS MANUALLY\n")
    if total_res == 0: print("NO REAL SOLUTION FOUND")
