...
ic = [0.538, 0.197, 0.002, 0.46]
p_true = [0.828, 0.366, 0.281, 0.071, 0.127, 0.837]
...
write("data/csv/bh_rand_8.csv", dat_str)
save("data/julia/bh_rand_8.jld2", "data", data_sample)
