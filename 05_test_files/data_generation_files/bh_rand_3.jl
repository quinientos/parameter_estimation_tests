...
ic = [0.515, 0.97, 0.192, 0.064]
p_true = [0.432, 0.498, 0.044, 0.949, 0.636, 0.868]
...
write("data/csv/bh_rand_3.csv", dat_str)
save("data/julia/bh_rand_3.jld2", "data", data_sample)
