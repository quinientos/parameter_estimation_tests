...
ic = [0.087, 0.256, 0.772, 0.659]
p_true = [0.894, 0.98, 0.345, 0.502, 0.674, 0.765]
...
write("data/csv/bh_rand_7.csv", dat_str)
save("data/julia/bh_rand_7.jld2", "data", data_sample)
