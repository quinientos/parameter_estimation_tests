...
def compile_results(system, instance, platform, csv_writer):
    res_file = "./test_files/"+ platform + "/outputs/{}.csv".format(instance["name"])
        ...
        for platform in PLATFORMS:
            ...
            with open("table_files/"+system["name"] + "_results_" + platform + ".csv", "w") as csv_file:
                ...
                for i in range(10):
                    ...
                    compile_results(system, instance, platform, csvwriter)            
