...
ic = [0.439, 0.988, 0.102, 0.209]
p_true = [0.667, 0.671, 0.21, 0.129, 0.315, 0.364, 0.57]
...
write("data/csv/daisy-mamil4_4.csv", dat_str)
save("data/julia/daisy-mamil4_4.jld2", "data", data_sample)
