...
ic = [0.121, 0.932, 0.432, 0.271]
p_true = [0.66, 0.256, 0.858, 0.532, 0.318, 0.191]
...
write("data/csv/bh_rand_9.csv", dat_str)
save("data/julia/bh_rand_9.jld2", "data", data_sample)
