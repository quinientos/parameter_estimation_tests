...
ic = [0.567, 0.265, 0.523, 0.094]
p_true = [0.12, 0.296, 0.119, 0.318, 0.414, 0.064, 0.692]
...
write("data/csv/daisy-mamil4_7.csv", dat_str)
save("data/julia/daisy-mamil4_7.jld2", "data", data_sample)
