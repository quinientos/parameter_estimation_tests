...
ic = [0.605, 0.739, 0.039, 0.283]
p_true = [0.821, 0.097, 0.838, 0.096, 0.976, 0.469, 0.977]
...
write("data/csv/daisy-mamil4_6.csv", dat_str)
save("data/julia/daisy-mamil4_6.jld2", "data", data_sample)
