...
ic = [0.592, 0.572, 0.223, 0.953]
p_true = [0.005, 0.678, 0.27, 0.735, 0.962, 0.249, 0.576]
...
write("data/csv/daisy-mamil4_9.csv", dat_str)
save("data/julia/daisy-mamil4_9.jld2", "data", data_sample)
