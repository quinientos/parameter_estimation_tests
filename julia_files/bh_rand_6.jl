...
ic = [0.364, 0.953, 0.846, 0.012]
p_true = [0.471, 0.674, 0.196, 0.498, 0.892, 0.913]
...
write("data/csv/bh_rand_6.csv", dat_str)
save("data/julia/bh_rand_6.jld2", "data", data_sample)
