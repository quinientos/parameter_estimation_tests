...
ic = [0.415, 0.265, 0.774, 0.456]
p_true = [0.461, 0.781, 0.118, 0.64, 0.143, 0.945, 0.522]
...
write("data/csv/daisy-mamil4_2.csv", dat_str)
save("data/julia/daisy-mamil4_2.jld2", "data", data_sample)
