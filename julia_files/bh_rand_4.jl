...
ic = [0.396, 0.41, 0.667, 0.288]
p_true = [0.715, 0.528, 0.389, 0.731, 0.591, 0.575]
...
write("data/csv/bh_rand_4.csv", dat_str)
save("data/julia/bh_rand_4.jld2", "data", data_sample)
