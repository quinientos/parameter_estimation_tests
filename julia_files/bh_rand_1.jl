...
ic = [0.754, 0.223, 0.577, 0.261]
p_true = [0.651, 0.612, 0.961, 0.864, 0.048, 0.882]
...
write("data/csv/bh_rand_1.csv", dat_str)
save("data/julia/bh_rand_1.jld2", "data", data_sample)
