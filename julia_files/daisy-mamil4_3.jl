...
ic = [0.36, 0.437, 0.698, 0.06]
p_true = [0.568, 0.019, 0.618, 0.612, 0.617, 0.944, 0.682]
...
write("data/csv/daisy-mamil4_3.csv", dat_str)
save("data/julia/daisy-mamil4_3.jld2", "data", data_sample)
