...
ic = [0.884, 0.334, 0.756, 0.507]
p_true = [0.498, 0.777, 0.354, 0.565, 0.331, 0.823]
...
write("data/csv/bh_rand_5.csv", dat_str)
save("data/julia/bh_rand_5.jld2", "data", data_sample)
